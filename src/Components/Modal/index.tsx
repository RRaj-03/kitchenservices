    ...
    <div className='min-w-[90%] mx-auto sm:w-auto scale-95'>
                  <div className="isolate bg-white px-6 py-8  lg:px-10">
                    ...
                    <div className="mx-auto max-w-2xl text-center">
                      <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-2xl">Book Appointment</h2>
                      {/* <p className="mt-0 text-sm leading-8 text-gray-600">kitchen chimney services.</p> */}

                    </div>
                    <form onSubmit={formik.handleSubmit} className="mx-auto mt-2 max-w-xl sm:mt-2">
                      <div className="grid grid-cols-1 gap-x-8 gap-y-1 sm:grid-cols-2 ">
                        <div className='w-full  justify-self-center'>
                          <label htmlFor="name" className="block text-xs font-semibold leading-6 text-gray-900">First name</label>
                          <div className="mt-0.5 relative">
                            <input type="text" name="name" id="name" autoComplete="given-name" className="block w-full rounded-md border-0 px-3.5 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs sm:leading-6" onChange={formik.handleChange}
                        ...
                        <div className='w-full  justify-self-center'>
                          <label htmlFor="Date" className="block text-xs font-semibold leading-6 text-gray-900">Date</label>
                          <div className="mt-0.5 relative">
                            <input type="date" name="Date" id="Date" autoComplete="off" className="block w-full rounded-md border-0 px-3.5 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs sm:leading-6" onChange={formik.handleChange}
                        ...
                        <div className='w-full  justify-self-center'>
                          <label htmlFor="phone" className="block text-xs font-semibold leading-6 text-gray-900">Phone Number</label>
                          <div className="mt-0.5 relative">
                            <input type="tel" name="phone" id="phone" autoComplete="organization" className="block w-full rounded-md border-0 px-3.5 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs sm:leading-6" onChange={formik.handleChange}
                        ...
                        <div className='w-full  justify-self-center'>
                          <label htmlFor="email" className="block text-xs font-semibold leading-6 text-gray-900">Email (optional)</label>
                          <div className="mt-0.5 relative">
                            <input type="email" name="email" id="email" autoComplete="email" className="block w-full rounded-md border-0 px-3.5 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs sm:leading-6" onChange={formik.handleChange}
                        ...
                        <div className=' w-full  justify-self-center relative'>
                          <div onClick={() => {
                            ...
                            >
                              {({ open }) => (
                                <>
                                  <Listbox.Label className="block text-xs font-semibold leading-6 text-gray-900">Service</Listbox.Label>
          ...
          <p className="mt-2 text-xs text-right absolute right-0 text-red-600 dark:text-red-500">
            <span className="font-medium">{formik.errors.price}</span>
                        ...
                        <div className=" w-full  justify-self-center relative">
                          <div onClick={() => {
                            ...
                            >
                              {({ open }) => (
                                <>
                                  <Listbox.Label className="block text-xs font-semibold leading-6  text-gray-900">City</Listbox.Label>
                                  <div className=" mt-0.5 ">
                                    <Listbox.Button className="relative w-full cursor-default rounded-md bg-white py-1 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 sm:text-xs sm:leading-6">
                                      <span className="flex items-center">
                        ...
                        <div className="sm:col-span-2 w-full  justify-self-center">
                          <label htmlFor="address" className="block text-xs font-semibold leading-6 text-gray-900">Address</label>
                          <div className="mt-0.5 relative">
                            <textarea name="address" id="address" rows={4} className="block w-full rounded-md border-0 px-3.5 py-1 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-xs sm:leading-6" onChange={formik.handleChange}
          ...
          <div className="flex min-h-full items-center justify-center text-center sm:items-center sm:p-0 ">
            ...
            >
              <Dialog.Panel className="relative md:min-w-[750px] min-w-[80%] my-4 max-h-fit transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className='h-8 w-8 absolute z-[1] right-0 mt-1 mr-1 s' onClick={() => {
                  setOpen(false)
                }}><XMarkIcon /></div>
                <Form/>
              </Dialog.Panel>
