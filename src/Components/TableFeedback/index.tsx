...
const Loading = () =>{
    return (
        <tr className="h-24 animate-pulse border-gray-300  border-b">
                                ...
                                <td className="pl-8 text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4"><div className="h-3 bg-slate-700 rounded"></div></td>
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4"><div className="h-3 bg-slate-700 rounded"></div></td>
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4"><div className="h-3 bg-slate-700 rounded"></div></td>
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4"><div className="h-3 bg-slate-700 rounded"></div></td>
...
const Table = () => {
    ...
    const fetchdata =async (pagenum:number)=>{
        ...
        const {Feedback , totalData} = data.data
  ...
  return (
    <div className="py-20">
            <div className="sm:mx-8 bg-white  shadow rounded">
                    ...
                    <table className="min-w-full bg-white ">
                        <thead>
                            ...
                            <tr className="w-full h-16 border-gray-300  border-b py-8">
                                ...
                                <th className="text-gray-600  font-normal pr-6 text-left text-sm tracking-normal leading-4">Message</th>
                        ...
                        <tbody>
                        {
                                ((Feedback.length===0)&&!loading)?<div className='w-full text-center'>Nothing to Show</div>:!loading?null:<Loading/>
                            }
                                {Feedback.map((task:any)=>{
                                    return(
                                        <tr key={task?._id} className="h-24 border-gray-300  border-b">
                                
                                
                                <td className="pl-8 text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4">{task?._id}</td>
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4">{task?.name}</td>
                                
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4">{task?.city}</td>
                                <td className="text-sm pr-6 whitespace-no-wrap text-gray-800  tracking-normal leading-4">{task?.message}</td>
