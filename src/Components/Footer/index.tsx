  ...
  return (
    <section className="bg-gray-700">
      <div className="w-[90%] mx-auto px-4 py-12 space-y-8 overflow-hidden sm:px-6 lg:px-8">
          ...
          <div className="mx-auto flex sm:flex-nowrap flex-wrap">
            <div className="lg:w-2/3 sm:w-1/2 w-full my-8 sm:my-0 h-[300px] sm:h-auto bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
              <iframe
                ...
                title="map"
                src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=Gadge Nagar, Amravati.&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
              ></iframe>
            </div>
              ...
              <div className="bg-white relative h-full flex flex-wrap flex-col gap-4 py-6 rounded shadow-md justify-around">
                ...
                <div className=" px-6 mt-4 lg:mt-0">
                  ...
                  <p className="text-indigo-500 leading-relaxed">
                    Rasoichimneyservices@gmail.com
                  </p>
                </div>
                <div className=" px-6 mt-4 lg:mt-0">
                  ...
                  <p className="leading-relaxed flex flex-wrap">
                    <a href={"tel:+91" + 9730947658}>+91 9730947658,</a>
                    <a href={"tel:+91" + 7720004562}>+91 7720004562,</a>
                  </p>
                </div>
              </div>
            </div>
        ...
        <hr />
        <h2 className="text-xl text-gray-300 text-center">Cities We Serve</h2>
        <div className="lg:flex !mt-4 lg:justify-between lg:items-center">
          <nav className="flex flex-wrap justify-center -mx-5 -my-2">
            {cities.map((city) => {
              return (
                <div
                  key={city}
                  className="px-5 py-2 text-gray-300 hover:text-gray-900 cursor-pointer"
                  onClick={() => {
        ...
        <div className="lg:flex lg: justify-between lg:items-center">
          ...
          <div className="flex justify-center mt-8 lg:mt-0 space-x-6">
