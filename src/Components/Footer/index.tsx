  ...
  <div className="mx-auto flex sm:flex-nowrap flex-wrap">
    ...
    <div className="bg-white relative h-full flex flex-wrap flex-col gap-4 py-6 rounded shadow-md justify-around">
        ...
        <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
          <a className="text-indigo-500 leading-relaxed">Rasoichimneyservices@gmail.com</a>
        </div>
        <div className=" px-6 mt-4 lg:mt-0">
                ...
                <div className='lg:flex lg: justify-between lg:items-center'>
                    <nav className="flex flex-wrap justify-center -mx-5 -my-2">
                        <div className="px-5 py-2">
                            <Link href="/Home" className="text-base leading-6 text-gray-300 hover:text-gray-900">
                                Home
                            </Link>
                        </div>
                        <div className="px-5 py-2">
                        ...
                        <div className="px-5 py-2">
                            <Link href="/Services" className="text-base leading-6 text-gray-300 hover:text-gray-900">
                                Services
                            </Link>
                        </div>
                        <div className="px-5 py-2">
                            <Link href="/BookAppointment" className="text-base leading-6 text-gray-300 hover:text-gray-900">
                                Book Appointment
                            </Link>
                        </div>
                    </nav>
