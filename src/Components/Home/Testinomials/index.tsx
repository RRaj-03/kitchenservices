    ...
    <div className="flex flex-wrap -m-4">
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded flex justify-between flex-col">
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="block w-5 h-auto text-gray-400 mb-4" viewBox="0 0 975.036 975.036">
          ...
          <Link className="inline-flex items-center" href={''}>
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">Yogesh Rathi</span>
              <span className="text-gray-500 text-sm">Badnera,Amravati</span>
            </span>
          </Link>
        </div>
      </div>
      <div className="p-4 md:w-1/2 w-full">
        <div className="h-full bg-gray-100 p-8 rounded flex justify-between flex-col">
          ...
          <p className="leading-relaxed mb-6">They performed the most comprehensive inspection, and had the most knowledgeable handyman.</p>
          <Link className="inline-flex items-center" href={''}>
            ...
            <span className="flex-grow flex flex-col pl-4">
              <span className="title-font font-medium text-gray-900">Piyush Chandak</span>
