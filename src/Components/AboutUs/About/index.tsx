        ...
        <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
          <div className="lg:max-w-md">
            ...
            <p className="px-4 mb-10 text-base leading-7 text-gray-500 ">
              We are experienced professionals working for fulfilling customers’
              requirements at the requested date and time.
            </p>
                ...
                <div className="p-6 bg-white ">
                  <span className="text-blue-500 ">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="h-10 w-10  bi bi-file-earmark-text"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="p-6 bg-white ">
                  <span className="text-blue-500 ">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="h-10 w-10  bi bi-people-fill"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="p-6 bg-white ">
                  <span className="text-blue-500 ">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="h-10 w-10  bi bi-person-fill"
                      viewBox="0 0 16 16"
                    >
                ...
                <div className="p-6 bg-white ">
                  <span className="text-blue-500">
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="h-10 w-10  bi bi-alarm-fill"
                      viewBox="0 0 16 16"
                    >
