      ...
      <div className="flex flex-wrap ">
        <div className="w-full px-4 mb-4 lg:w-2/5 ">
          <div className="relative overflow-hidden shadow-lg group">
            <img
              src="https://i.postimg.cc/hPvHtWNV/pexels-antoni-shkraba-4348404.jpg"
        ...
        <div className="w-full px-4 mb-8 lg:w-3/5 ">
          <div className="relative overflow-hidden shadow-lg group">
            <img
              src="https://i.postimg.cc/mgDMnVzL/pexels-caio-56759.jpg"
              className="group-hover:origin-center group-hover:scale-105 transition inset-0 object-cover object-center  duration-500 w-full h-[350px]"
              alt=""
            />
            <div className="absolute inset-0 z-0 group-hover:bg-black opacity-60"></div>
        ...
        <div className="w-full px-4 mb-8 lg:w-3/5 ">
          <div className="relative overflow-hidden shadow-lg group">
            <img
              src="https://i.postimg.cc/Jhf3wJZs/pexels-visual-tag-mx-2566581.jpg"
              className="group-hover:origin-center group-hover:scale-105 transition inset-0 object-cover object-center  duration-500 w-full h-[350px]"
              alt=""
            />
            <div className="absolute inset-0 z-0 group-hover:bg-black opacity-60"></div>
        ...
        <div className="w-full px-4 mb-8 lg:w-2/5 ">
          <div className="relative overflow-hidden shadow-lg group">
            <img
              src="https://i.postimg.cc/mgrb8Ztg/pexels-pixabay-38271.jpg"
              className="group-hover:origin-center group-hover:scale-105 transition inset-0 object-cover object-center  duration-500 w-full h-[350px]"
              alt=""
            />
            <div className="absolute inset-0 z-0 group-hover:bg-black opacity-60"></div>
        ...
        <div className="w-full px-4 mb-8 lg:w-3/5 ">
          <div className="relative overflow-hidden shadow-lg group">
            <img
              src="https://i.postimg.cc/JnPkrd2d/pexels-marc-mueller-380769.jpg"
              className="group-hover:origin-center group-hover:scale-105 transition inset-0 object-cover object-center  duration-500 w-full h-[350px]"
              alt=""
            />
            <div className="absolute inset-0 z-0 group-hover:bg-black opacity-60"></div>
