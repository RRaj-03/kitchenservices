...
export default function Navbar() {
  ...
  return (
    <>
      <Disclosure
        as="nav"
        className={`ease-in duration-500 transition-all   z-10 fixed w-full ${
          visible ? "top-0" : "md:-top-16 -top-[104px]"
        }`}
      >
        {({ open }) => (
          <div
            className={`ease-in duration-500 transition-color ${
              prevScrollPos === 0 ? "hover:bg-gray-800" : "bg-gray-800"
            } ${open ? "bg-gray-800" : ""}`}
          >
                ...
                <div className="hidden sm:ml-2  sm:block">
                  <div className="flex space-x-2 items-center">
                    ...
                    <Link
                      ...
                      key={"Book Now"}
                      className={
                        "text-white lg:!ml-4 whitespace-nowrap bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 md:px-2 lg:px-5 py-2.5 text-center"
                      }
                      // onClick={() => {
            ...
            <Disclosure.Panel className="sm:hidden">
              <div className="space-y-0.5 pb-3 pt-2">
                ...
                <Link
                  key={"Book Now"}
                  className={
                    "block text-white whitespace-nowrap bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 md:px-2 lg:px-5 py-2.5 "
                  }
                  href={"/BookAppointment"}
                  aria-current={current === "Book Now" ? "page" : undefined}
                >
            ...
            <div className="items-center justify-center pb-2 pr-2 text-sm ml-2  rounded-md flex md:hidden">
              <label
                htmlFor="search"
                className="hidden sm:inline mr-2 text-gray-300"
              >
                City:
              </label>
